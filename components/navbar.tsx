    ...
    return (
        ...
        <nav className='w-full flex items-center justify-start gap-10 h-auto px-8 py-6'>
            <a href="/">
             ...
             <div className='flex items-stretch justify-start px-8 py-4 gap-12 bg-white/70 backdrop-blur-lg rounded-full shadow-sm'>
             <a href="#projects" className='font-sans font-medium'> Projects </a>

        ...
        >
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
                ...
                items.map((it, idx) => (
                  ...
                  >
                    <a
                      ...
                      data-index={idx + 1}
                    >
                      <span className="sm-panel-itemLabel inline-block [transform-origin:50%_100%] text-[#4a4a4a] will-change-transform">
                        {it.label}
                      </span>
                    </a>
                  </li>
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              ...
              >
                <h3 className="sm-socials-title m-0 text-base font-medium text-[#4a4a4a]">
                  Socials
                </h3>
                <ul
                  ...
                  {socialItems.map((s, i) => (
                    <li key={s.label + i} className="sm-socials-item">
                      <a
                        ...
                        className="sm-socials-link text-[1.2rem] font-medium text-[#4A4A4A] no-underline relative inline-block py-[2px] transition-[color,opacity] duration-300 ease-linear"
                      >
                        {s.label}
                      </a>
                    </li>
...
.sm-scope .sm-logo-img { display: block; height: 42px; width: auto; object-fit: contain; }
...
.sm-scope .sm-panel-item { position: relative; color: #000; font-weight: 600; font-size: 3.2rem; cursor: pointer; line-height: 1; letter-spacing: -2px; text-transform: uppercase; transition: background 0.25s, color 0.25s; display: inline-block; text-decoration: none; padding-right: 1.4em; }
.sm-scope .sm-panel-itemLabel { display: inline-block; will-change: transform; transform-origin: 50% 100%; }
.sm-scope .sm-panel-item:hover { color: var(--sm-accent, #4A4A4A); }
.sm-scope .sm-panel-list[data-numbering] { counter-reset: smItem; }
.sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { counter-increment: smItem; content: counter(smItem, decimal-leading-zero); position: absolute; top: 0.1em; right: 3.2em; font-size: 18px; font-weight: 400; color: var(--sm-accent, #4a4a4a); letter-spacing: 0; pointer-events: none; user-select: none; opacity: var(--sm-num-opacity, 0); }

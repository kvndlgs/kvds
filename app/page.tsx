    ...
    <main className="w-full flex flex-col items-center justify-center m-0 p-0">
      <div className="w-full h-screen flex items-center justify-center">
        ...
        <div className="w-4/5 h-auto flex flex-col gap-6 md:z-100">
          <h1 className="lg:text-[100px] lg:leading-[110px]  md:text-[100px] md:leading-[90px] text-[64px] leading-[70px] font-sans-heavy text-[#4D4D4D] pb-4">Full Stack Developer
